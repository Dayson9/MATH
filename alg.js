var dataset = [{input: "4 plus 6", output: "4 + 6"}, {input: "4 times 16", output: "4 * 16"}, {input: "{4} ( {x} {+} {7} )", output: "4 * x + 4 * 7"}, {input: "{x} + 2 = 3", output: "x = 3 - 2"}],  pattern = [];
...
const pred1 = (p, int) => {
  let prediction = "", ext = "", tst, len, i, tmp = int.split(" "), bool = false;
